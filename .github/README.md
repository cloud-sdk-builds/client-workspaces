...
[`@aws-sdk/client-workspaces`](https://www.npmjs.com/package/@aws-sdk/client-workspaces/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-az+JKkF1MlVh854chBwxUcJxXCyG43aSqsYVbKKB0cMUe6B2ifksXNtVwnGHU1DP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workspaces": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.936.0/index.min.mjs": "sha384-az+JKkF1MlVh854chBwxUcJxXCyG43aSqsYVbKKB0cMUe6B2ifksXNtVwnGHU1DP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workspaces/blob/refs/tags/3.936.0/LICENSE
```
