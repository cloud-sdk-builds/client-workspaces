...
[`@aws-sdk/client-workspaces`](https://www.npmjs.com/package/@aws-sdk/client-workspaces/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h8iTP4RMRgOkkG2RgSBRCHucbDLAanAS3/Xs1jvxivptSakyLutUg8CGeM4tuFwG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workspaces": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.290.0/index.min.mjs": "sha384-h8iTP4RMRgOkkG2RgSBRCHucbDLAanAS3/Xs1jvxivptSakyLutUg8CGeM4tuFwG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workspaces/blob/refs/tags/3.290.0/LICENSE
```
