...
[`@aws-sdk/client-workspaces`](https://www.npmjs.com/package/@aws-sdk/client-workspaces/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zE9q2L8LDnjLdLZM9G+X3vhGVlZuWV8a+7JaRxRVI4F3spKlP1eUWi64kAcDLN4c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-workspaces": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-workspaces@3.955.0/index.min.mjs": "sha384-zE9q2L8LDnjLdLZM9G+X3vhGVlZuWV8a+7JaRxRVI4F3spKlP1eUWi64kAcDLN4c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-workspaces/blob/refs/tags/3.955.0/LICENSE
```
